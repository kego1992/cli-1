...
importContentTypes.prototype = {
  start: function (credentialConfig) {
    ...
    mapperFolderPath = path.join(config.data, config.target_stack, 'mapper', 'content_types')
    globalFieldMapperFolderPath =  helper.readFile(path.join(config.data, config.target_stack, 'mapper', 'global_fields', 'success.json'))
    globalFieldPendingPath =  helper.readFile(path.join(config.data, config.target_stack, 'mapper', 'global_fields', 'pending_global_fields.js'))
    globalFieldUpdateFile =  path.join(config.data, config.target_stack, 'mapper', 'global_fields', 'success.json')
